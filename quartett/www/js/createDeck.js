...
function loadGUIPageThree(attributeNumber){
	...
	case 3:
		...
		$("#new_deck_next_card").click(function() {
			...
			if(isNaN(parseFloat(getVal1))|| isNaN(parseFloat(getVal2)) || isNaN(parseFloat(getVal3))){
				alert("Bitte korrekte Zahlen eingeben: z.B. 4 oder 4.6");
	...
	case 4:
		...
		$(value2).attr('id', 'value2');
		$(value2).append('<div class="flex-row-menu custom_textbox"><input type="text" id="new_card_value1" placeholder="Wert">'+
							'<div>'+newDeck.attributes[1].type+'</div></div>');
		...
		$(value3).attr('id', 'value3');
		$(value3).append('<div class="flex-row-menu custom_textbox"><input type="text" id="new_card_value1" placeholder="Wert">'+
							'<div>'+newDeck.attributes[2].type+'</div></div>');
		var attribute4 = $("<div>");
		...
		$(value4).append('<div class="flex-row-menu custom_textbox"><input type="text" id="new_card_value1" placeholder="Wert">'+
		...
		$("#new_deck_next_card").click(function() {
			...
			if(isNaN(parseFloat(getVal1))|| isNaN(parseFloat(getVal2)) || isNaN(parseFloat(getVal3)) || isNaN(parseFloat(getVal4))){
				alert("Bitte korrekte Zahlen eingeben: z.B. 4 oder 4.6");
	...
	case 5:
		...
		$("#new_deck_next_card").click(function() {
			...
			if(isNaN(parseFloat(getVal1))|| isNaN(parseFloat(getVal2)) || isNaN(parseFloat(getVal3)) || isNaN(parseFloat(getVal4)) || isNaN(parseFloat(getVal5))){
				alert("Bitte korrekte Zahlen eingeben: z.B. 4 oder 4.6");
...
function loadNewCard(attributeNumber){
	...
	case 5:
		...
		$(value5).append('<div class="flex-row-menu custom_textbox">'+
							'<div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">'+
							'<input type="text" id="new_card_value5" placeholder="Wert"></div>'+
							'<div>'+newDeck.attributes[4].type+'</div></div>');
